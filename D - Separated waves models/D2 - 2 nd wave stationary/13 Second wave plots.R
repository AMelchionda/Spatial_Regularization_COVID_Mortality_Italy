...
load('solutions_wave2_newton.RData')
...
plot_results(solutions, nx = 500, ny = 500, case = '2nd',
             file_name = '2nd_wave_static.pdf')

plot_results(solutions, nx = 500, ny = 500, case = '2nd', show_lambda = F,
             file_name = '2nd_wave_static_NOlambda.pdf')
